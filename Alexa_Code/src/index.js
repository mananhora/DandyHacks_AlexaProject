...
var APP_ID = "amzn1.ask.skill.3d8d344e-2530-45ac-9849-ff1a98aed7d5";// TODO replace with your app ID (OPTIONAL).
...
var topFiveIntro = "Here are the top fivefive things to  do in " + location + ".";
...
var newSessionHandlers = {
    ...
    "FoodRecsInCity": function(){
        this.handler.state = states.SEARCHMODE;
        this.emitWithState('FoodRecsInCity');
    },
    ...
    "MoreInfoOnRestaurant": function(){
        this.handler.state = states.SEARCHMODE;
        this.emitWithState('MoreInfoOnRestaurant');
    },
};
...
var startSearchHandlers = Alexa.CreateStateHandler(states.SEARCHMODE, {
    ...
    "FoodRecsInCity": function () {
        ...
        var slotValue = this.event.request.intent.slots.city.value;

        var currentState = this;
        var returnedData = yelpTest.yelpSearchByCity("Food", slotValue).then(function(data){
            output = "Here are Yelp's top five recommendations: "+data.businesses[0].name+" ,   "+data.businesses[1].name+" , "+data.businesses[2].name+"  ,  "+data.businesses[3].name+"  ,   "+data.businesses[4].name;
            console.log("bye");
            output+="Would you like to know more about any of these?";
            businesses = data.businesses;
            currentState.emit(':ask', output, 'Sorry, say that again');
            console.log("bye");
        }).then(function(){
            console.log("hello");
        });
    ...
    "MoreInfoOnRestaurant":function(){
        ...
        var description = businesses[slotValue].snippet_text;
        var location = businesses[slotValue].location.cross_streets;
        output = description+", ,   ,"+"located near "+location;
